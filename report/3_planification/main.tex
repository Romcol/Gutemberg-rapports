...
\begin{document}
    ...
    \input{input/recherche.tex}

    \input{input/consultation.tex}

    \input{input/revue.tex}

    \input{input/accueil.tex}

    \input{input/utilisateur.tex}

    \input{input/planification.tex}
