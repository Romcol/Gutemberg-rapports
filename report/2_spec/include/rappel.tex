...
Également, Yoann Royer, chef de projet chez Sopra Steria et ancien diplômé de l’INSA, nous offre son accompagnement tout au long du projet.
    ...
    qu’un tuilage des revues avec chargement asynchrone est nécessaire. %(On parle ici d’OpenSeaDragon ?) NO. (0.01s)
    ...
    surbrillance. %(Comprend pas de quoi tu parles)
    ...
    un résultat quasi-instantané. %(ElasticSearch ?)
