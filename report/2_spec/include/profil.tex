...
\begin{itemize}
  ...
  \item Marquer des articles afin de pouvoir les retrouver facilement si l'utilisateur souhaite les relire plus tard. Ces articles seront rangés dans une liste appelée "Articles favoris". Les articles pourront aussi être enlevés par le propriétaire de la revue.
